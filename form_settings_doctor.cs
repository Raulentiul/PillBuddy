...
{
    public partial class form_settings_doctor : Form
    {
        public form_settings_doctor()
        {
            InitializeComponent();
        }

        private void back_button_settings_doctor_Click(object sender, EventArgs e)
        {
        ...
        private void label_change_phone_number_doctor_Click(object sender, EventArgs e)
        {
        ...
        private void label_change_password_doctor_Click(object sender, EventArgs e)
        {
            // create a new instance of a Form object
            Form popup = new Form();
        ...
        private void label_change_email_doctor_Click(object sender, EventArgs e)
        {
            // create a new instance of a Form object
            Form popup = new Form();
